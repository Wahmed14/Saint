Public Class Employees
    ...
    Public Sub New(id As Integer, last_name As String, first__name As String, phone_number As String, email As String, gender As String, function_field As String)
        Me.Id = id
